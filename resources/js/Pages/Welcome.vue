<template>
    ...
    <div
        ...
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <template v-else>
                <Link v-if="canLogin" href="/login" class="text-sm text-gray-700 underline">
                    Log in
                </Link>
    ...
    <h2 v-text="canLogin"></h2>
    <Link v-if="canLogin" href="#" class="text-blue-500 text-sm ml-3">New Users</Link>
    <h2 v-text="canRegister"></h2>
    <h2 v-text="laravelVersion"></h2>
    <h2 v-text="phpVersion"></h2>
</template>
